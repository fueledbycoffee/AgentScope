import type {
  ...
  Mapping, MappingDetail, MetricsSummary, Page, PreviewRequest, RawRecord,
...
function query(params: Page & Scope & { code?: string; file_sha256?: string; locator?: string } = {}) {
...
export const listRejects = (id: string, params?: Page & { code?: string }) =>
